...
//    }
    ...
    @Test
    public void getTest(){
        Person person = session.get(Person.class,"402881c0602ef35a01602ef3668b0000");
//        System.out.println("personName-------->"+person.getName());
//        System.out.println("--------------------------------------------------------");
//        System.out.println("IdCard------------>"+person.getIdCard());
//        System.out.println("--------------------------------------------------------");
//        System.out.println("IdCardNo---------->"+person.getIdCard().getCardNo());
    }

    @Test
    public void loadTest(){
        Person person = session.load(Person.class,"402881c0602ef35a01602ef3668b0000");
        System.out.println("----------------------------");
        person.getName();//发送sql  延迟加载
    }
}
