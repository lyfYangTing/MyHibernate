...
//    }
    ...
    public void testSave() {
        ...
        c1.setCatregoryName("Cate-A-double");

        Category c2 = new Category();
        c2.setCatregoryName("Cate-B-double");

        Item i1 = new Item();
        i1.setItemName("Item-A-double");
        Item i2 = new Item();
        i2.setItemName("Item-B-double");
        //通过c1,c2找到与之关联的i1,i2
        c1.getItems().add(i1);
        c1.getItems().add(i2);
        c2.getItems().add(i1);
        ...
        session.save(c1);
        session.save(c2);
//        session.save(i1);  @ManyToMany注解中声明级联关系时可以省略
//        session.save(i2);  @ManyToMany注解中声明级联关系时可以省略
    }
    ...
    public void updateCategoryTest() {//重新建立关联关系，以前已经存在的关系全部不要了
        ...
        Item item1 = new Item();
        item1.setItemName("测试-double");
        item1.getCategories().add(category);//添加的新的关联关系

        Item item2 = new Item();
        item2.setItemName("测试1-double");
